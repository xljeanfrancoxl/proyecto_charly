                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="ejemplo1" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                <?php foreach($categoria as $rec_cate){?>
                                        <tr>
                                            <td><?= $rec_cate['Id_categoria'] ?></td>
                                            <td><?= $rec_cate['nombre_categoria'] ?></td>
                                            <td>
                                                <!-- <button style="border: none; background-color: transparent; color: #007bff;"id="detalle-producto" idse="<?=$rec_cate['Id_producto']?>"><i class="fas fa-book"></i></button> -->
                                                <button style="border: none; background-color: transparent; color: #007bff;"id="editar-producto" idsec="<?=$rec_cate['Id_categoria']?>"><i class="fas fa-edit"></i></button>
                                                <button style="border: none; background-color: transparent; color: #007bff;"id="eliminar-producto" ids="<?=$rec_cate['Id_categoria']?>"><i class="fas fa-trash-alt"></i></button>
                                            </td>
